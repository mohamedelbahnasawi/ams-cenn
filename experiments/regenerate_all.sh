#!/usr/bin/env bash
# Regenerate the AMS-CeNN tables and figures from the existing result JSONs.
...
# 1. aggregate the per-run JSONs into the status report and the LaTeX-ready tables
...
# 2b. manuscript tables and the numbers quoted in the prose, written to aggregated/paper_tables/
