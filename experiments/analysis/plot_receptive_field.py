...
K micro-steps it has seen K*d + 1 steps (3, 5, 9, 17 at K=2; confirmed by an impulse test on the
trained model), whereas the two Linear(L -> H) maps of the model (the projection layer inside the
...
cellular receptive fields and the 512-step linear maps are legible on one plot; a bar runs from 1 to
