"""Robustness and gate figures:
  fig08_robustness.pdf       degradation curves under the five perturbation kinds
  fig09_gate_adaptation.pdf  gate variation, pointwise vs context gate, and the accuracy effect
Outputs go to the figures directory (FIGURES_DIR).
"""
import csv, os
...
ROBUSTNESS_CSV = "experiments/robustness/robustness_degradation.csv"
...
def fig_gate():
    ...
    # left: alpha temporal std, pointwise vs context, log scale, 0.05 adaptation threshold
    cats = ["standard\nbenchmarks", "synth\nchirp", "synth\nhetero"]
    ...
    # right: accuracy on SynthHetero, fixed vs pointwise vs context
